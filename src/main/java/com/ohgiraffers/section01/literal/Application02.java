...
public class Application02 {
    ...
    public static void main(String[] args) {
        ...
        *  결국 지금까지 연산은 숫자끼리의 연산을 본 것이고, 숫자(정수 혹은 실수) 형태의 값은 사칙연산과 모드 연산이 가능하다.
        *  */

        /* 목차. 3. 문자열의 연산 */
        /* 목차. 3-1. 문자열과 문자열의 연산 */
        //필기. 문자열과 문자열의 + 연산은 문자열 합치기 (이어붙이기)가 된다.
...
//        System.out.println("hello"%"world");
        ...
        //필기. ctrl - / 그 줄 아무데서나 누르면 전체 주석처리가 된다.
...
//        System.out.println("=======================논리값과 논리값 연산==========================");
